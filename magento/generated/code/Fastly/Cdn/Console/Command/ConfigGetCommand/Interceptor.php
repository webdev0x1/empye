<?php
namespace Fastly\Cdn\Console\Command\ConfigGetCommand;

/**
 * Interceptor class for @see \Fastly\Cdn\Console\Command\ConfigGetCommand
 */
class Interceptor extends \Fastly\Cdn\Console\Command\ConfigGetCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Fastly\Cdn\Model\Config $config, \Fastly\Cdn\Model\Api $api, \Fastly\Cdn\Helper\Vcl $vcl)
    {
        $this->___init();
        parent::__construct($config, $api, $vcl);
    }
