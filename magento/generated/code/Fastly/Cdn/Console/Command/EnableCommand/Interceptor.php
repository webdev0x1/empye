<?php
namespace Fastly\Cdn\Console\Command\EnableCommand;

/**
 * Interceptor class for @see \Fastly\Cdn\Console\Command\EnableCommand
 */
class Interceptor extends \Fastly\Cdn\Console\Command\EnableCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Fastly\Cdn\Model\Config $config, \Fastly\Cdn\Model\Api $api, \Fastly\Cdn\Helper\Vcl $vcl, \Magento\Framework\App\Config\Storage\WriterInterface $configWriter, \Magento\Framework\App\Cache\Manager $cacheManager, \Magento\Framework\Filesystem $filesystem, \Fastly\Cdn\Model\Upload\Acl $acl, \Fastly\Cdn\Model\Upload\Dictionary $dictionary)
    {
        $this->___init();
        parent::__construct($config, $api, $vcl, $configWriter, $cacheManager, $filesystem, $acl, $dictionary);
    }
