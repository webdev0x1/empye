<?php
namespace Fastly\Cdn\Console\Command\SerializeToJson;

/**
 * Interceptor class for @see \Fastly\Cdn\Console\Command\SerializeToJson
 */
class Interceptor extends \Fastly\Cdn\Console\Command\SerializeToJson implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, \Magento\Framework\App\Config\Storage\WriterInterface $configWriter, \Magento\Framework\App\ProductMetadataInterface $productMetadata, \Magento\Framework\App\Cache\Manager $cacheManager, \Magento\Framework\Serialize\Serializer\Serialize $serialize)
    {
        $this->___init();
        parent::__construct($scopeConfig, $configWriter, $productMetadata, $cacheManager, $serialize);
    }
