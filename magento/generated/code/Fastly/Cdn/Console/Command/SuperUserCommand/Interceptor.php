<?php
namespace Fastly\Cdn\Console\Command\SuperUserCommand;

/**
 * Interceptor class for @see \Fastly\Cdn\Console\Command\SuperUserCommand
 */
class Interceptor extends \Fastly\Cdn\Console\Command\SuperUserCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Fastly\Cdn\Model\Config $config, \Fastly\Cdn\Model\Api $api, \Fastly\Cdn\Helper\Vcl $vcl, \Magento\Framework\Filesystem $filesystem)
    {
        $this->___init();
        parent::__construct($config, $api, $vcl, $filesystem);
    }
