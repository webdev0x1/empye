<?php
namespace Fastly\Cdn\Console\Command\ConfigImportCommand;

/**
 * Interceptor class for @see \Fastly\Cdn\Console\Command\ConfigImportCommand
 */
class Interceptor extends \Fastly\Cdn\Console\Command\ConfigImportCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Fastly\Cdn\Model\Api $api, \Fastly\Cdn\Helper\Vcl $vcl, \Fastly\Cdn\Model\Importer $importer, $name = null)
    {
        $this->___init();
        parent::__construct($api, $vcl, $importer, $name);
    }
