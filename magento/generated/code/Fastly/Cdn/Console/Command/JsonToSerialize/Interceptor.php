<?php
namespace Fastly\Cdn\Console\Command\JsonToSerialize;

/**
 * Interceptor class for @see \Fastly\Cdn\Console\Command\JsonToSerialize
 */
class Interceptor extends \Fastly\Cdn\Console\Command\JsonToSerialize implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, \Magento\Framework\App\Config\Storage\WriterInterface $configWriter, \Magento\Framework\App\ProductMetadataInterface $productMetadata, \Magento\Framework\Serialize\SerializerInterface $serializer, \Magento\Framework\App\Cache\Manager $cacheManager)
    {
        $this->___init();
        parent::__construct($scopeConfig, $configWriter, $productMetadata, $serializer, $cacheManager);
    }
