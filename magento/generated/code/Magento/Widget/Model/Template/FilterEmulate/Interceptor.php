...
class Interceptor extends \Magento\Widget\Model\Template\FilterEmulate implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterDirective');
        return $pluginInfo ? $this->___callPlugins('filterDirective', func_get_args(), $pluginInfo) : parent::filterDirective($value);
    }
