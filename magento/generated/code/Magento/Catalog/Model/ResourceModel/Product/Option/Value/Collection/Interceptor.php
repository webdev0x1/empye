...
class Interceptor extends \Magento\Catalog\Model\ResourceModel\Product\Option\Value\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getValues');
        return $pluginInfo ? $this->___callPlugins('getValues', func_get_args(), $pluginInfo) : parent::getValues($storeId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addTitlesToResult');
        return $pluginInfo ? $this->___callPlugins('addTitlesToResult', func_get_args(), $pluginInfo) : parent::addTitlesToResult($storeId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getValuesByOption');
        return $pluginInfo ? $this->___callPlugins('getValuesByOption', func_get_args(), $pluginInfo) : parent::getValuesByOption($optionIds, $storeId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addOptionToFilter');
        return $pluginInfo ? $this->___callPlugins('addOptionToFilter', func_get_args(), $pluginInfo) : parent::addOptionToFilter($option);
    }
