...
factory.get('body').pushContainer('body',t.returnStatement(returnStatement));}};var programVisitor={ExpressionStatement:function ExpressionStatement(path){var amdModule=(0,_astUtils.findAmdModule)(path);if(amdModule){processAmdDefinition(amdModule);}}};function _default(){return{visitor:{Program:{exit:function exit(path){path.traverse(programVisitor);}}}};}