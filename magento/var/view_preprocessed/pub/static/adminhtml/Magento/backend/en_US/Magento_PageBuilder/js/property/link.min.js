define([],function(){var Link=function(){"use strict";function Link(){this.regexpByLinkType={category:new RegExp(/id_path=['"]category\/(\d+)/),product:new RegExp(/id_path=['"]product\/(\d+)/),page:new RegExp(/page_id=['"](\d+)/)};}
...
return attributeIdMatches[1];};return Link;}();return Link;});